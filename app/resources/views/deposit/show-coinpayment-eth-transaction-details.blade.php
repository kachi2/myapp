                    ...
                    <div class="row mb-4 mt-3">
                        <div class="col-12">
                            <div class="card-img" style="width: 100%" align="center">
                                <img src="{{ asset('/0x049ba6a757b5e85c2383478f778411a59a6d16ef.png') }}"   alt="{{ $transaction->address }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="post" action="{{ route('deposits.invest', ['id' => $plan->id]) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="0x049ba6a757b5e85c2383478f778411a59a6d16ef" class="form-control" id="inputAmount">
                                </div>
                            </form>
                        </div>
                    </div>
