                    ...
                    <div class="row mb-4 mt-3">
                        <div class="col-12">
                            <div class="card-img" style="width: 100%" align="center">
                                <img src="{{ asset('/LaPJqhcWvKAaeDJPvQ3EnYUnWnWtLfBkwH.png') }}"   alt="{{ $transaction->address }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="post" action="{{ route('deposits.invest', ['id' => $plan->id]) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="LaPJqhcWvKAaeDJPvQ3EnYUnWnWtLfBkwH" class="form-control" id="inputAmount">
                                </div>
                            </form>
                        </div>
                    </div>
