                        ...
                        <div class="card-inner">
                            <div class="qr-media mx-auto mb-3 w-max-100px">
                                <!--?xml version="1.0" encoding="UTF-8"?-->
                                            <g transform="scale(3.03)"><g transform="translate(0,0)">
                                                    <img src="{{asset('/LhDbviHgM1RZrNBxbFceWZf6T6NPeELuny.jpg')}}"
                                                    </g></g>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input readonly="" type="text" class="form-control form-control-lg" id="wallet-address" value="LhDbviHgM1RZrNBxbFceWZf6T6NPeELuny" readonly>
                                </div>
                                                            </div>
