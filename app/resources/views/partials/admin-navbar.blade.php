                        ...
                        <div class="nk-sidebar-menu">
                            ...
                            <ul class="nk-menu apps-menu">
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin.home') }}" class="nk-menu-link" title="Dashboard">
                                        <span class="nk-menu-icon"><em class="icon ni ni-dashboard"></em></span>
                                    </a>
                                </li>
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin.users') }}" class="nk-menu-link" title="Manage Users">
                                        <span class="nk-menu-icon"><em class="icon ni ni-user"></em></span>
                                    </a>
                                </li>
                               
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin.deposits') }}" class="nk-menu-link" title="Manage Deposits">
                                ...
                                <li class="nk-menu-item">
                                    <a href="#" class="nk-menu-link" title="Notifications">
                                ...
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin.packages') }}" class="nk-menu-link" title="Packages">
